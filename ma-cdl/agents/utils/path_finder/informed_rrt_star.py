...
class InformedRRTStar:
    ...
    def informed_rrt_star_search(self, start, goal, obstacles, animation=True):
    ...
    def find_near_nodes(self, new_node):
        ...
        r = 0.01 * math.sqrt((math.log(n_node) / n_node))
    ...
    def draw_graph(self, x_center=None, c_best=None, c_min=None, e_theta=None,
        ...
        if rnd is not None:
            ...
            if c_best != float('inf'):
                self.plot_ellipse(x_center, c_best, c_min, e_theta, self.rot_mat_2d)
    ...
    @staticmethod
    def plot_ellipse(x_center, c_best, c_min, e_theta, rot_mat_2d):  # pragma: no cover
